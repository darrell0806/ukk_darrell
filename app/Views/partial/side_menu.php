    ...
    <div class="sidebar-wrapper active">
      <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
          <div class="logo">
          <a href="<?=base_url('dashboard')?>"><img src="<?=base_url('logo/logo_website/'.$logo->logo_website)?>" alt="Logo" width="100%"/></a>
          </div>
      ...
      <?php if (session()->get('level')==1){ ?>
        <div class="sidebar-menu">
          <ul class="menu">
            ...
            <li class="sidebar-item <?php if($uri->getSegment(1) == "pelanggan"){echo "active";}?>">
              <a href="<?=base_url('pelanggan')?>" class='sidebar-link'>
                <i class="fa-solid fa-screen-users"></i>
                <span>Data Pelanggan</span>
              </a>
            </li>
            <li class="sidebar-item <?php if($uri->getSegment(1) == "produk"){echo "active";}?>">
            ...
            <li class="sidebar-title">Data Transaksi</li>
                    ...
                    <li class="sidebar-item <?php if($uri->getSegment(1) == "kasir"){echo "active";}?>">
                      <a href="<?=base_url('kasir')?>" class='sidebar-link'>
                        <i class="fa-solid fa-calendar-days"></i>
                        <span>Kasir Penjualan</span>
                      </a>
                    </li>
                    <li class="sidebar-item <?php if($uri->getSegment(1) == "penjualan"){echo "active";}?>">
                ...
                <li class="sidebar-item  <?php if($uri->getSegment(1) == "menu_laporan"){echo "active";}?>">
                  <a href="<?=base_url('menu_laporan')?>" class='sidebar-link'>
                    <i class="fa-solid fa-book"></i>
